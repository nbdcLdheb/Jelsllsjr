...
icon.Image = "rbxassetid://137095609033635"
...
desc.Text = "Auto Bonds Premium Version"
...
if game.PlaceId == 70876832253163 or game.PlaceId == 98018823628597 then
    ...
    local success, err = pcall(function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/gwnrdt/gwnrdt/refs/heads/main/Auto-Bonds.lua"))()
    end)

    if not success then
        warn("[Hutao Hub] Auto Bond script failed to load:", err)
    end
end
